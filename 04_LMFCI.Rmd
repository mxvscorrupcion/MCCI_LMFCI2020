...
Si bien para el producto final se realizaron modificaciones estéticas a partir de una base de datos que sólo contenía los datos usados en cada texto, la automatización del proceso de análisis le permitió a MCCI-UIA echar un vistazo inmediato a los principales resultados de la encuesta MCCI-Reforma 2020.
